    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            const Text('Selamat datang di Aplikasi Resto!'),
            SizedBox(height: 20,),
            ElevatedButton(
              onPressed: () {
                Navigator.push(
...
class _MenuPageState extends State<MenuPage> {
  ...
  List<FoodMenu> foodMenus = [
    FoodMenu(
      imageUrl: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80', 
      name: 'Pasta', 
      price: 45000
    ),
    FoodMenu(
      imageUrl: 'https://images.unsplash.com/photo-1676300185292-e23bb3db50fa?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80', 
    ...
    FoodMenu(
      imageUrl: 'https://images.unsplash.com/photo-1601702538934-efffab67ab65?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80', 
      name: 'Pickle Herring', 
      price: 71000
    ),
    FoodMenu(
    ...
    FoodMenu(
      imageUrl: 'https://images.unsplash.com/photo-1555196301-9acc011dfde4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80', 
...
class _AboutPageState extends State<AboutPage> {
  ...
  String restaurantInteriorUrl = 'https://images.unsplash.com/photo-1587899897387-091ebd01a6b2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90bylwYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1513&q=80';
  String restaurantName = 'Restaurant Wih Enak';
